  ...
  return (
    <>
      ...
      <QueueView
        ...
        labels={{
          inQueue: t("queue2"),
          assignedToMe: t("assignedMe"),
          unassigned: t("unassigned2"),
          pastSla: t("pastSla"),
          searchPlaceholder: t("searchReferenceProjectUnitSeller"),
          statusFilter: t("status"),
          signalsFilter: t("signals"),
          file: t("file"),
          status: t("status"),
          ...
          noMatching: t("noFilesMatchSelectedFilters"),
          mine: t("mine"),
          due: t("due"),
          overdueBy: t("overdue"),
        }}
